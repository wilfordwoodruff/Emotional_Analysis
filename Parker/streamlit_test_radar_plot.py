...
if authenticate(password):
    # Upload the data
    df = pd.read_csv("C:/Users/14026/Desktop/School/current semester/Consulting Wilford Woodruff/Log-adjusted Hume scores.csv")
    emotion_mapping = pd.read_csv("C:/Users/14026/Desktop/School/current semester/Consulting Wilford Woodruff/emotion_categories_updated.csv")
